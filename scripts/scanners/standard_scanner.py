...
if __name__ == "__main__":
    # Reuse unified scanner with standard preset
    parser = argparse.ArgumentParser(description="Standard Scanner (merged JSON + single context)")
    ...
    try:
        ...
        scanner.additional_ignore_dirs = set(args.ignore)
        scanner.scan_project(export_context=True, split_by="none", single_report_only=False, generate_init=args.generate_init)
