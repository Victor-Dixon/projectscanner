...
The migration target is to make ProjectScanner the normalized repository-planning evidence producer, then make DreamVault consume that normalized evidence. Existing direct-file consumers remain until semantic parity is proven.
